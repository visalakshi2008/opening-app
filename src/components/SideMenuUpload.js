                            ...
                            <li className='pb-[10px] '>
                             ...
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class="ms-3 text-[#9A9AA9] font-semibold ">Dashboard</span>
                                </a>
                            </li>
                            <li className='pb-[10px] '>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#9A9AA9] font-semibold">Upload</span>
                            ...
                            <li className='pb-[10px] '>
                             ...
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#9A9AA9] font-semibold">Invoice</span>
                            ...
                            <li className='pb-[10px] '>
                             ...
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#9A9AA9] font-semibold">Schedule</span>
                                </a>
                            </li>
                            <li className='pb-[10px] '>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#9A9AA9] font-semibold">Calendar</span>
                                </a>
                            </li>
                            <li className='pb-[10px] '>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#9A9AA9] font-semibold">Notifications</span>
                                </a>
                            </li>
                            <li className='pb-[10px] '>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#9A9AA9] font-semibold">Settings</span>
                                </a>
                            </li>
                        </ul>
                    </div >
