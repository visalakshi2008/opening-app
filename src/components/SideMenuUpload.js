                                                ...
                                                <ul className="space-y-2 font-medium pt-8">
                                                    <li className='pb-2'>
                                                        <button className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                            ...
                                                            <span className="ms-3 text-[#030229] font-semibold">Dashboard</span>
                                                        </button>
                                                    </li>
                                                    <li className='pb-2'>
                                                        <button className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                            ...
                                                            <span className="ms-3 text-[#030229] font-semibold">Upload</span>
                                                        </button>
                                                    </li>
                                                    <li className='pb-2'>
                                                        <button className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                            ...
                                                            <span className="ms-3 text-[#030229] font-semibold">Invoice</span>
                                                        </button>
                                                    </li>
                                                    <li className='pb-2'>
                                                        <button className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                            ...
                                                            <span className="ms-3 text-[#030229] font-semibold">Schedule</span>
                                                        </button>
                                                    </li>
                                                    <li className='pb-2'>
                                                        <button className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                            ...
                                                            <span className="ms-3 text-[#030229] font-semibold">Calendar</span>
                                                        </button>
                                                    </li>
                                                    <li className='pb-2'>
                                                        <button className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                            ...
                                                            <span className="ms-3 text-[#030229] font-semibold">Notifications</span>
                                                        </button>
                                                    </li>
                                                    <li className='pb-2'>
                                                        <button className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                            ...
                                                            <span className="ms-3 text-[#030229] font-semibold">Settings</span>
                                                        </button>
                                                    </li>
                                                </ul>
                                            </div>
                            ...
                            <li className='pb-[10px] '>
                             ...
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class="ms-3 text-[#030229] font-semibold ">Dashboard</span>
                                </a>
                            </li>
                            <li className='pb-[10px] '>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#030229] font-semibold">Upload</span>
                            ...
                            <li className='pb-[10px] '>
                             ...
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#030229] font-semibold">Invoice</span>
                            ...
                            <li className='pb-[10px] '>
                             ...
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#030229] font-semibold">Schedule</span>
                                </a>
                            </li>
                            <li className='pb-[10px] '>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#030229] font-semibold">Calendar</span>
                                </a>
                            </li>
                            <li className='pb-[10px] '>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#030229] font-semibold">Notifications</span>
                                </a>
                            </li>
                            <li className='pb-[10px] '>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white
                             hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                 ...
                                 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true"
                                    ...
                                    <span class=" ms-3 text-[#030229] font-semibold">Settings</span>
                                </a>
                            </li>
                        </ul>
                    </div >
