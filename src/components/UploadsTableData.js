            ...
            <table className="min-w-full bg-white border rounded shadow-md">
                <thead>
                    <tr>
                        ...
                        <th className="py-2 px-4 border-b text-back font-semibold">Select Tags</th>
                            ...
                            <td className=''>
                                <div className='flex gap-2 justify-center items-center'>
                                    <div className="relative inline-block">
                                        <span className="px-2 py-1 cursor-pointer pr-8">
                                            Select Tags
                                        </span>
                                        ...
                                        <div className={`absolute bg-green-500 border border-gray-200 shadow-md rounded mt-1 right-0 ${isDropdownOpen[index] ? 'block' : 'hidden'}`}>
